...
if exist('OCTAVE_VERSION','builtin')
    ...
    mex(arraydims,'LDFLAGS=$LDFLAGS -Wl,-ld_classic', '-Imatlab_matrix','metanetwork_reduce.cpp', 'matlab_matrix/full.cpp', 'matlab_matrix/sparse.cpp', 'group_index.cpp')
    mex(arraydims,'LDFLAGS=$LDFLAGS -Wl,-ld_classic', '-Imatlab_matrix', 'group_handler.cpp', 'matlab_matrix/full.cpp', 'matlab_matrix/sparse.cpp', 'group_index.cpp')
